...
enum FunctionCodeE {
    ...
    FUNCTION_CODE_SWITCH_VALVE_DOWN = 0x61,
    FUNCTION_CODE_SWITCH_VALVE_UP = 0x62,
    FUNCTION_CODE_VALVE_SET_HEAT_TIME_DOWN = 0x67,
    FUNCTION_CODE_VALVE_SET_HEAT_TIME_UP = 0x68,
    FUNCTION_CODE_VALVE_CONFIG_DOWN = 0x69,
    FUNCTION_CODE_VALVE_CONFIG_UP = 0x6A,
